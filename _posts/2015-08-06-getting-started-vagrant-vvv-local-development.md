...
5. If you want to be able to use other devices (e.g. mobile phone) to get to the virtual machine, you need to configure Vagrant with `config.vm.network :public_network` as recommended by [webdevstudios](http://webdevstudios.com/2015/08/04/how-to-view-a-locally-developed-website-devices/).
6. 
